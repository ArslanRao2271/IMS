...
function Dashboard() {
  ...
  const fetchTotalSaleAmount = () => {
    fetch(
      `https://test-backend-cyan.vercel.app/api/sales/get/${authContext.user}/totalsaleamount`
    )
  ...
  const fetchTotalPurchaseAmount = () => {
    fetch(
      `https://test-backend-cyan.vercel.app/api/purchase/get/${authContext.user}/totalpurchaseamount`
    )
      .then((response) => response.json())
  ...
  const fetchMonthlySalesData = () => {
    fetch(`https://test-backend-cyan.vercel.app/api/sales/getmonthly`)
      .then((response) => response.json())
